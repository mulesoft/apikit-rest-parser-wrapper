...
import org.mule.validation.exception.InvalidQueryParameterException;
...
public class QueryParameterValidator implements AttributesValidator {

  private final Action action;
  private final boolean queryParamsStrictValidation;

  public QueryParameterValidator(Action action, boolean queryParamsStrictValidation) {
    this.action = action;
    this.queryParamsStrictValidation = queryParamsStrictValidation;
  }

  public void validate(HttpRequestAttributes attributes)
      throws InvalidQueryParameterException {

    MultiMap<String, String> queryParams = attributes.getQueryParams();
