...
import org.mule.validation.body.form.DataWeaveTransformer;
...
public class UrlencodedFormV1Validator implements BodyValidator {

  private final Map<String, List<Parameter>> formParameters;
  private final DataWeaveTransformer dataWeaveTransformer;

  public UrlencodedFormV1Validator(MimeType mimeType, ExpressionManager expressionManager) {
    this.formParameters = mimeType.getFormParameters();
    this.dataWeaveTransformer = new DataWeaveTransformer(expressionManager);
  }

  @Override
  public TypedValue validate(String charset, TypedValue originalPayload) throws BadRequestException {
