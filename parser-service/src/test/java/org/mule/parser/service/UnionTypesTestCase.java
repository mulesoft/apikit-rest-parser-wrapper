...
public class UnionTypesTestCase {
    ...
    public void testQueryParametersUnion() {
        Parameter parameter = api.getResources().get(QUERY_PARAM_UNION_RESOURCE).getAction(GET_ACTION).getQueryParameters().get(PARAM_VALUE);
    ...
    public void testUriParametersUnion() {
        Parameter parameter = api.getResources().get(URI_PARAM_UNION_RESOURCE).getAction(GET_ACTION).getResolvedUriParameters().get(PARAM_VALUE);
        assertTrue(parameter.validate("123"));
        assertTrue(parameter.validate("2020-01-19"));
