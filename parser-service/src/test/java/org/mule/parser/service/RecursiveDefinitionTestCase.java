...
public class RecursiveDefinitionTestCase {
    ...
    public void validJsonWithRecursiveDefinition() {
        ...
        assertTrue(mimeType.validate("{\"value\": \"root\",\"left\": {\"value\": \"child1\"},\"right\": {\"value\": \"child2\",\"left\": {\"value\": \"child21\"},\"right\": {\"value\": \"child22\"}}}").isEmpty());
        assertFalse(mimeType.validate("{\"value\": \"root\",\"left\": {\"value\": \"child1\"},\"right\": {\"value2\": \"child2\",\"left\": {\"value\": \"child21\"},\"right\": {\"value\": \"child22\"}}}").isEmpty());
    }
